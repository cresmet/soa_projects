...
declare namespace sud="http://www.w3.org/2005/xquery-local-functions";
...
declare function local:funcInsertorders($CallOrders_getOrderList_OutputVariable.reply as element() (:: schema-element(ord:OrderResponse) ::)) as element() (:: schema-element(ins:SbcExpeditorStgTblCollection) ::) {
    <ins:SbcExpeditorStgTblCollection>
    {
      for $Orders in $CallOrders_getOrderList_OutputVariable.reply/ord:Rows/ord:Orders[ord:OrderStatus=3]
...
local:funcInsertorders($CallOrders_getOrderList_OutputVariable.reply)
